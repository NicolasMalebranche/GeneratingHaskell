-- implements the cup product according to Lenh/Sorger and Qin/Wang
module HilbK3 where
...
-- integer base to ordinary base according to Qin/Wang
...
-- ordinary base to integer base according to Qin/Wang
