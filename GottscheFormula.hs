...
-- Hilb^n modulo ideal generated by H1
-- in case surface is abelian
bettiMod1Hilbert n = Polynomial (k-4) $ p*q where
	Polynomial k p = bettiHilbert n
	q = (seriesInvShift 1)^b1
