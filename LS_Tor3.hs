...
l 5 = [ [([Ch 0 a, Ch 0 15],1 )]| a<-[1..4]] ++
	[ [([Ch 0 a, Ch 0 b, Ch 0 c],1 )]| a<-[1..4] , b<-[a+1..4], c<-[11..14]] ++
	[ [([Ch 0 a, Ch 0 b],1 )]| a<-[5..10], b<-[11..14]] ++
	[ [([Ch 0 a, Ch 0 b, Ch 0 c],1 )]| a<-[1..4] , b<-[5..10], c<-[b..10]] ++
	[ [([Ch 1 a],1 )]|a <- [11..14]] ++ 
	[ [([Ch 0 a, Ch 1 0],1 )]|a <- [11..14]] ++ 
	[ [([Ch 0 a, Ch 1 b],1 )]|a <- [1..4],b<-[5..10]] ++ 
	[ [([Ch 1 a, Ch 0 b],1 )]|a <- [1..4], b<-[5..10]] ++
	[ k a | a<-[1..4]]  

l 6 = [ [([Ch 0 a, Ch 0 15],1 )]| a<-[5..10]] ++
	[ [([Ch 0 a, Ch 0 b, Ch 0 15],1 )]| a<-[1..4], b<-[a+1..4]] ++
	[ [([Ch 0 a, Ch 0 b],1 )]| a<-[11..14], b<-[a+1..14]] ++
	[ [([Ch 0 a, Ch 0 b, Ch 0 c],1 )]| a<-[11..14], b<-[5..10],c <-[1..4]] ++
	[ [([Ch 0 a, Ch 0 b, Ch 0 c],1 )]| a<-[5..10], b<-[a..10],c <-[b..10]] ++
	[ [([Ch 1 0, Ch 0 15],1 )], [([Ch 1 15],1 )] ] ++
	[ [([Ch 0 a, Ch 1 b],1 )]| a<-[1..4], b<-[11..14]] ++
	[ [([Ch 0 a, Ch 1 b],1 )]| a<-[11..14], b<-[1..4]] ++
	[ [([Ch 0 a, Ch 1 b],1 )]| a<-[5..10], b<-[5..10]] ++
	[ [([Ch 2 a],1 )]| a<-[5..10]] 

l 7 = [ [([Ch 0 a, Ch 0 15],1 )]| a<-[11..14]] ++
	[ [([Ch 0 a, Ch 0 b, Ch 0 15],1 )]| a<-[5..10], b <-[1..4]] ++
	[ [([Ch 0 a, Ch 0 b, Ch 0 c],1 )]| a<-[11..14], b <-[a+1..14], c<-[1..4]] ++
	[ [([Ch 0 a, Ch 0 b, Ch 0 c],1 )]| a<-[11..14], b <-[5..10], c<-[b..10]] ++
	[ [([Ch 0 a, Ch 1 15],1 )]| a<-[1..4]] ++ [ [([Ch 1 a, Ch 0 15],1 )]| a<-[1..4]] ++
	[ [([Ch 0 a, Ch 1 b],1 )]| a<-[11..14],b<-[5..10] ] ++ 
	[ [([Ch 0 a, Ch 1 b],1 )]| a<-[5..10] ,b<-[11..14]] ++
	[ [([Ch 2 a],1 )]| a<-[11..14]] 
...
l 9 = [ [([Ch 0 a, Ch 0 15, Ch 0 15],1 )]| a<-[1..4]] ++
	[ [([Ch 0 a, Ch 0 b, Ch 0 15],1 )]| a<-[5..10], b<-[11..14]] ++
	[ [([Ch 0 a, Ch 0 b, Ch 0 c],1 )]| a<-[11..14], b<-[a+1..14], c<-[b+1..14]] ++
...
-- Tangentialbündel
c2Tang = (scale (3%2) $ foldr add (Vak []) [ scale x $ nakaState (P (-1) 0: map (P (-1))r)  | (r,x) <- gfa_comultN 1 (Tor 0)]) `add` 
...
c4Tang = scale (4%3) $ foldr add (Vak []) [ scale x $ nakaState (map (P (-1))r)  | (r,x) <- gfa_comultN 2 (Tor 0)]
